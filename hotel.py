...
class HotelManagementSystem:
    def __init__(self,root):
        ...
        #ist img
        img1=Image.open(r"F:\\PSG\\year 2\\semester 4\\rdbms\\package\\hotel management system\\hotel management system\\hotel1.jpg")
        ...
        #logo
        img2=Image.open(r"F:\\PSG\\year 2\\semester 4\\rdbms\\package\\hotel management system\\hotel management system\\hotel2.jpg")
        ...
        #image
        img3=Image.open(r"F:\\PSG\\year 2\\semester 4\\rdbms\\package\\hotel management system\\hotel management system\\hotel3.jpg")
        ...
        #down image
        img4=Image.open(r"F:\\PSG\\year 2\\semester 4\\rdbms\\package\\hotel management system\\hotel management system\\hotel4.jpg")
        img4 = img4.resize((230, 210))
        self.photoimg4=ImageTk.PhotoImage(img4)
        lblimg1=Label(main_frame,image=self.photoimg4,bd=4,relief=RIDGE)
        lblimg1.place(x=0,y=225,width=230,height=210)

        img5=Image.open(r"F:\\PSG\\year 2\\semester 4\\rdbms\\package\\hotel management system\\hotel management system\\hotel5.jpg")
