...
class LoginWindow:
    def __init__(self,root):
        ...
        self.bg=ImageTk.PhotoImage(file=r"F:\\PSG\\year 2\\semester 4\\rdbms\\package\\hotel management system\\hotel management system\\login.jpg")
        ...
        img1=Image.open(r"F:\\PSG\\year 2\\semester 4\\rdbms\\package\\hotel management system\\hotel management system\\login icon.jpg")
